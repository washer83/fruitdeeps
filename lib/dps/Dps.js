...
export class Dps {
    ...
    pickSpec(weapon) {
        console.log(`pickSpec called with weapon: ${weapon}`);
        switch (weapon) {
            case "Tonalztics of ralos":
            case "Tonalztics of ralos (Uncharged)":
                return "Ninja star";
    ...
    applySpecials() {
        ...
        if (this.calcs.flags.includes("Tonalztics of ralos (Charged)")){
            this.calcs = specs.ralosCharged()
        }
        if (this.calcs.flags.includes("Tonalztics of ralos (Uncharged)")){
            this.calcs = specs.ralosUncharged()
        }
    ...
    output() {
        ...
        console.log(`output called with weapon: ${weapon}`);
        ...
        if (spec !== null && this.calcs.specName === null) {
            console.log(`Setting specName: ${spec}`);
