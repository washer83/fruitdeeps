...
export class Flags {
    ...
    weapon() {
        ...
        if (weapon.includes("Tonalztics of ralos (Uncharged)")){
            console.log(`Setting UNCHARGED RALOS FLAG for weapon: ${weapon}`);
            return ["Tonalztics of ralos (Uncharged)"]
        }        
        if (weapon.includes("Tonalztics of ralos")){
            console.log(`Setting CHARGED RALOS FLAG for weapon: ${weapon}`);
            return ["Tonalztics of ralos (Charged)"]
